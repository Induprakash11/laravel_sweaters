				...
				"data":[
					{
						...
						"pro_img" : "img/priority/truellysel.svg",
						"client_img": "img/icons/company-icon-01.svg",
					...
					},
					{
						...
						"subject" : "Web Design",
						"sent_to" : "Redwood Inc",
						"pro_img" : "img/priority/project-01.svg",
						"client_img": "img/icons/company-icon-10.svg",
						"total_value" : "$2,105",
						"project" : "Dreamsports",
						"piority" : "0",
					...
					},
					{
						...
						"sent_to" : "HarborView",
						"pro_img" : "img/priority/best.svg",
						"client_img": "img/icons/company-icon-08.svg",
					...
					},
					{
						...
						"pro_img" : "img/priority/project-02.svg",
						"client_img": "img/icons/company-icon-07.svg",
						"total_value" : "$2,05,426",
						"project" : "Doccure",
						"piority" : "0",
					...
					},
					{
						...
						"pro_img" : "img/priority/project-01.svg",
						"client_img": "img/icons/company-icon-05.svg",
					...
					},
					{
						...
						"subject" : "Web Design",
						"sent_to" : "Summit  Peak",
						"pro_img" : "img/priority/dream-pos.svg",
						"client_img": "img/icons/company-icon-04.svg",
						"total_value" : "$6,154",
						"project" : "DreamPOS",
						"piority" : "0",
					...
					},
					{
						...
						"subject" : "Logo",
						"sent_to" : "Silver Hawk",
						"pro_img" : "img/priority/servbook.svg",
						"client_img": "img/icons/company-icon-03.svg",
						"total_value" : "$1,457",
						"project" : "Servbook",
						"piority" : "0",
					...
					},
					{
						...
						"pro_img" : "img/priority/truellysell.svg",
						"client_img": "img/icons/company-icon-02.svg",
					...
					},
					{
						...
						"pro_img" : "img/priority/dreamchat.svg",
						"client_img": "img/icons/company-icon-09.svg",
