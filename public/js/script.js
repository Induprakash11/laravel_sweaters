			  ...
			  events: [
				{
				  title: '',
				  images: [
					{ url: 'img/users/user-01.jpg', data: 'James Carter - 10:00 AM to 11:00 AM' },
					{ url: 'img/users/user-02.jpg', data: 'Sophia Wilson - 10:30 AM to 11:30 AM' }
				  ],					
				...
				},
				{
					title: '',
					images: [
					  { url: 'img/users/user-03.jpg', data: 'Thomas -  10:00 AM to 11:00 AM' },
					  { url: 'img/users/user-04.jpg', data: 'Shaver - 10:30 AM to 11:30 AM' },
					  { url: 'img/users/user-05.jpg', data: 'Ann - 10:00 AM to 11:00 AM' },
					  { url: 'img/users/user-06.jpg', data: 'Claffin - 11:00 AM to 12:00 PM' },
					  { url: 'img/users/user-07.jpg', data: 'Enrique - 12:30 PM to 01:30 PM' }
					],					
					backgroundColor: 'rgba(0, 0, 0, .2)',				  
				  ...
				  },
				  {
					  title: '',
					  images: [
						{ url: 'img/users/user-08.jpg', data: 'David Smith -  10:00 AM to 11:00 AM' },
						{ url: 'img/users/user-09.jpg', data: 'Deacon - 10:30 AM to 11:30 AM' },
						{ url: 'img/users/user-10.jpg', data: 'Stone - 10:00 AM to 11:00 AM' },
						{ url: 'img/users/user-11.jpg', data: ' Evans - 11:00 AM to 12:00 PM' }
					  ],					
					  backgroundColor: 'rgba(0, 0, 0, .2)',				  
					  start: new Date($.now() - 338000000).toJSON().slice(0, 10) 
				  },
				  {
					  title: '',
					  images: [
						{ url: 'img/users/user-12.jpg', data: 'Daniel Williams -  10:00 AM to 11:00 AM' },
						{ url: 'img/users/user-13.jpg', data: 'Deacon - 10:30 AM to 11:30 AM' },
						{ url: 'img/users/user-14.jpg', data: 'Stone - 10:00 AM to 11:00 AM' },
						{ url: 'img/users/user-15.jpg', data: ' Evans - 11:00 AM to 12:00 PM' }
					  ],					
					  backgroundColor: 'rgba(0, 0, 0, .2)',				  
			...
			<div class="screenshot-info-top bg-dark position-fixed top-0 start-0 p-2 w-100">
				<div class="d-flex align-items-center justify-content-center">				
					<a href="employee-details.html" class="avatar avatar-sm me-2 flex-shrink-0 avatar-rounded">
						<img src="img/users/user-04.jpg" class="img-fluid" alt="img">
					</a>
