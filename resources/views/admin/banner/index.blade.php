...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Banner<span
                                class="badge badge-soft-primary ms-2">{{ count($banner) }}</span></h4>
    ...
    <!-- delete modal -->
    <div class="modal fade" id="delete_banner">
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <p class="mb-3">Are you sure you want to remove banner you selected.</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            createForm.action = '{{ route("banner.store") }}';
        });
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelector('#banner-table').addEventListener('click', function (e) {
                if (e.target.closest('.edit-btn')) {
                    ...
                    fetch('{{ url("banner") }}/' + bannerId)
                        ...
                        .then(data => {
                            // form fields
                            editForm.action = '{{ url("banner") }}/' + bannerId;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var deleteModal = document.getElementById('delete_banner');
            deleteModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget;
                var bannerId = button.getAttribute('data-id');
                var form = document.getElementById('delete-form');
                form.action = '{{ route("banner.index") }}/' + bannerId;
            });
        });
    </script>
</body>
