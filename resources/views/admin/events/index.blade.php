...
<body>
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add_2" style="width: 30%">
        <div class="offcanvas-header border-bottom">
            <h5 class="fw-semibold">Add Events</h5>
            <button type="button"
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <p class="mb-3">Are you sure you want to remove event you selected.</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            createForm.action = '{{ route("events.store") }}';
        });
            ...
            document.querySelector('#events-table').addEventListener('click', function (e) {
                if (e.target.closest('.edit-btn')) {
                    ...
                    fetch('{{ url("events") }}/' + eventId)
                        ...
                        .then(data => {
                            // form fields
                            editForm.action = '{{ url("events") }}/' + eventId;
                            editForm.querySelector('#title-input').value = data.title || '';
                            editForm.querySelector('#description-input').value = data.description || '';
        ...
        // delete event script
        document.addEventListener('DOMContentLoaded', function () {
            var deleteModal = document.getElementById('delete_event');
