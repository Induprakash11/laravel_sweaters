                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class=""><a href="{{ url('product_details/' . encodeId($product->id)) }}"><img src="{{ asset($product->product_image) }}" alt=""></a></figure>
                                <div class="lower-content">
                                    <span class="post-date">{{ $product->date }}</span>
                                    <h3><a href="{{ url('product_details/' . encodeId($product->id)) }}">{{ $product->product_name }}</a></h3>
