                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                <figure class="product-image">
                                    <img src="{{ asset($getProductDetails->image) }}" alt="">
                                    <a href="{{ asset($getProductDetails->image) }}" class="lightbox-image"><i
                                            class="flaticon-search-2"></i></a>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                <div class="product-info">
                                    <h3>{{ $getProductDetails->brand }}</h3>
                                    ...
                                    <div class="text">
                                        <p>{{ $getProductDetails->construction }}</p>
                                        <ul class="list clearfix">
                                            <li>{{ $getProductDetails->fabric }}</li>
                                            <li>{{ $getProductDetails->gauge }}</li>
                                            <li>{{ $getProductDetails->moq }}</li>
                                        </ul>
                                    </div>
